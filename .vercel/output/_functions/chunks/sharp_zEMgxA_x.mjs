...
import { Q as NoImageMetadata, X as MissingSharp, ht as AstroError, pt as UnsupportedImageFormat, v as detector } from "./path_i6cKp1c9.mjs";
import { i as resolveDefaultOutputFormat, r as parseQuality, t as baseService } from "./service_CLO3dMKj.mjs";
//#region node_modules/.pnpm/astro@7.2.0_@emnapi+core@1._a868896625ac6079d71fa550cab9faf0/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./lib_BiOd-e3-.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default;
	} catch {
